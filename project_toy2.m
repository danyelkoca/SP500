...
% This program tests the model with toy data - 2
...
n = 100; % Proportinal to the size of input  
l = 0.1; %Determines how spread out the data points are

input = [];
label = [];
input = [input; repmat([-1,1], n, 1) + l * randn(n,2)];
label = [label ; zeros(n,1)];
input = [input; repmat([1,1], n, 1) + l * randn(n,2)];
label = [label ; zeros(n,1)];
input = [input; repmat([0,0], n, 1) + l * randn(n,2)];
label = [label ; zeros(n,1)];
input = [input; repmat([-1,-1], n, 1) + l * randn(n,2)];
label = [label ; zeros(n,1)];
input = [input; repmat([1,-1], n, 1) + l * randn(n,2)];
...
input = [input; repmat([0,1], n, 1) + l * randn(n,2)];
label = [label ; ones(n,1)];
input = [input; repmat([-1,0], n, 1) + l * randn(n,2)];
label = [label ; ones(n,1)];
input = [input; repmat([1,0], n, 1) + l * randn(n,2)];
label = [label ; ones(n,1)];
input = [input; repmat([0,-1], n, 1) + l * randn(n,2)];
...
figure(1); ; hold on;  
scatter(input(1:5*L/9,1) , input(1:5*L/9,2), 'k.' );
scatter(input(5*L/9+1:L,1) , input(5*L/9 + 1:L,2), 'g.' );
